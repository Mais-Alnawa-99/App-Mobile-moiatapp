export default [
  ...
  },
  {
    ...
    relatedServiceId: 1053,
    title: 'إصدار بطاقة بيان منتج للتحقق من المركبات الواردة المستعملة',
    Category_Id: 'db59caa7-fe90-4a79-b347-fd6063eeeaf5',
    startButton: {
      url: 'https://eservices.moiat.gov.ae/eservices/issue-product-label-card-for-used-imported-vehicles?lang=ar',
    },
  ...
  // },
  {
    ...
    description:
      'اعتماد مختبرات الفحص حسب المواصفة القياسية الدولية ISO/IEC 17025 اعتماد مختبرات المعايرة حسب المواصفة القياسية الدولية ISO/IEC 17025 اعتماد جهات التفتيش وفقاً للمواصفة القياسية الدولية ISO/IEC 17020 اعتماد جهات منح شهادات المطابقة للعمليات، والمنتجات، والخدمات وفقاً للمواصفة القياسية الدولية ISO/IEC 17065 اعتماد جهات منح شهادات المطابقة للحلال حسب المواصفات القياسية ذات العلاقة UAE.S GSO 2055-2, OIC/SMIIC 2 اعتماد في مجال المختبرات الطبية حسب المواصفة القياسية الدولية ISO 15189',
    sections: [
      {
        label: 'برامج الاعتماد',
        Requirements: [
          'مختبرات الفحص والمعايرة وفقاً لمتطلبات المواصفة الدولية ISO/IEC 17025:2017',
          'جهات التفتيش وفقاً لمتطلبات المواصفة الدولية ISO/IEC 17020:2012',
          'جهات منح شهادات المطابقة للمنتجات وفقاً لمتطلبات المواصفة الدولية ISO/IEC 17065:2012',
          'المختبرات الطبية وفقاً لمتطلبات المواصفة الدولية ISO 15189:2012',
          'جهات منح شهادات الحلال وفقاً للمواصفة الإماراتية UAE S 2055-2:2016',
        ],
      },
      {
        label: 'إجراءات الخدمة',
    ...
    sections: [
      ...
      },
      {
        ...
        Requirements: [
          ...
          'الحصول على الاعتماد خلال سنة من تاريخ استصدار شهادة التسجيل إذا كانت الجهة تزاول أنشطة في المجالات الإلزامية للاعتماد',
        ],
      },
    ],
    serviceFees: {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        label: 'المتطلبات',
        Requirements: [
          'تسجيل الدخول على المنصة الرقمية لخدمات الوزارة (moiat.gov.ae)',
          'تقديم طلب تعديل شهادة تسجيل جهة تقييم المطابقة',
          'إرفاق الوثائق المطلوبة',
          'دفع الرسوم',
          'استلام شهادة تسجيل جهات تقييم المطابقة محدثة',
        ],
      },
    ],
    serviceFees: {
  ...
  },
  {
    ...
    type: 'il',
    Category_Id: 'a0476a86-81d8-4964-9b81-b2093250774f',
    title: 'شهادة القيمة المضافة طبقا لقواعد المنشأ العربية',
    generalDocument: {
      title: 'المستندات العامة',
      description: 'دليل الخدمات الرقمية لوزارة الصناعة والتكنولوجيا المتقدمة',
      size: 'KB 2204',
  ...
  },
  {
    ...
    relatedServiceId: 1154,
    title: 'إصدار شهادة المحتوى الوطني​',
